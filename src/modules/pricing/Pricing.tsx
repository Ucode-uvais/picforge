...
const plans = [
  {
    ...
    price: "₹0",
    period: "forever",
    description: "Perfect for trying out PicForge AI",
    features: [
      "20 edits on free plan",
  ...
  },
  {
    ...
    price: "₹99",
    period: "per month",
    description: "Unlimited image forging  for professionals",
    features: [
      "Unlimited edits",
              ...
              >
                ...
                <div className="space-y-4 mb-8">
                  {plan?.features?.map((feature) => (
                    //changing key from index to feature,to give unique identifier
                    <div
                      key={feature}
